...
class IniciarSesion_App(QDialog):
    ...
    def __init__(self):
        ...
        self.w_conexionPri = None

        # Declaración de los controladores de eventos (Event Handler).
        self.uiVentanaPrin.btnAceptar.clicked.connect(self.pro_iniciar_sesion)
        self.uiVentanaPrin.btnCancelar.clicked.connect(self.pro_cancelar_sesion)
        self.uiVentanaPrin.btnResetPass.clicked.connect(self.pro_cambiar_contrasena)
        self.uiVentanaPrin.txtUsuario.textChanged.connect(self.pro_validar_usuario)
        self.uiVentanaPrin.txtContrasena.textChanged.connect(self.pro_validar_contrasena)
    ...
    def pro_validar_usuario(self):
        ...
        w_email = self.uiVentanaPrin.txtUsuario.text().strip()
        ...
        if w_email == '':
            ...
            self.uiVentanaPrin.btnValidaUsuario.setStyleSheet('image: url();')
        ...
        # Si el texto del email no ha sido validado por el patrón de emails.
            ...
            # Se muestra la imagen de error auxiliar.
            self.uiVentanaPrin.btnValidaUsuario.setStyleSheet('image: url(:/imagenes/dato_erroneo.ico);')
            # Se indica que el usuario no esta validado.
            self.w_validacion_usuario = False
        ...
        # Si el usuario ha sido rellenado y validado.
            ...
            self.uiVentanaPrin.btnValidaUsuario.setStyleSheet('image: url(:/imagenes/dato_correcto.ico);')
    ...
    def pro_validar_contrasena(self):
        ...
        w_contrasena = self.uiVentanaPrin.txtContrasena.text().strip()
        ...
        if w_contrasena == '':
            ...
            self.uiVentanaPrin.btnValidaContrasena.setStyleSheet('image: url();')
        ...
        # Si la contraseña no ha sido validada por el patrón de alfanuméricos.
            ...
            # Se quita la imagen de error auxiliar.
            self.uiVentanaPrin.btnValidaContrasena.setStyleSheet('image: url(:/imagenes/dato_erroneo.ico);')
            # Se indica que la contraseña no esta validada.
            self.w_validacion_contrasena = False
        ...
        # Si la contraseña ha sido rellena y validada por el patrón.
            ...
            # Se muestra la imagen de campo validado auxiliar.
            self.uiVentanaPrin.btnValidaContrasena.setStyleSheet('image: url(:/imagenes/dato_correcto.ico);')
    ...
    def pro_comprobar_estado_boton_aceptar(self):
        ...
        if self.w_validacion_usuario and self.w_validacion_contrasena:
            self.uiVentanaPrin.btnAceptar.setEnabled(True)
        else:
            self.uiVentanaPrin.btnAceptar.setEnabled(False)
    ...
    def pro_iniciar_sesion(self):
        ...
        w_usuario = self.uiVentanaPrin.txtUsuario.text().strip()
        w_contrasena = self.uiVentanaPrin.txtContrasena.text().strip()

        # Si la conexión ha sido correcta y w_conexionPri no esta vacía.
        if self.w_conexionPriPri is not None:

            # Se consulta en la tabla usuarios los datos del usuario a buscar.
            w_cursor = self.w_conexionPriPri.cursor()
            ...
            if w_registros is not None:
                ...
                # pantalla.
                    ...
                    self.uiVentanaPrin.txtContrasena.setText('')
                    self.uiVentanaPrin.txtContrasena.setFocus(True)
            ...
            # Si no ha recuperado el registro del usuario, se muestra un mensaje de error por pantalla.
                ...
                self.uiVentanaPrin.txtContrasena.setText('')
                self.uiVentanaPrin.txtUsuario.setFocus(True)
    ...
    def pro_conexion_bbdd(self):
        ...
        try:
            ...
            self.w_conexionPri = conexion_bbdd('curso_pyqt')
...
class ModificarContrasena_App(QDialog):
    ...
    def __init__(self, w_usuario):
        ...
        print(type(w_usuario))
        print(w_usuario)

        print(type(self.w_usuario))
        print(self.w_usuario)
